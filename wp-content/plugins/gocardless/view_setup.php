...
<input type="text" readonly="true" class="regular-text" value="<?php echo site_url(); ?>" />
...
<table>
<tr><td>App ID</td><td><input type="text" name="app_id" class="regular-text" value="<?php echo $gocardless_config['app_id']; ?>" /></td></tr>
<tr><td>App secret</td><td><input type="text" name="app_secret" class="regular-text" value="<?php echo $gocardless_config['app_secret']; ?>" /></td></tr>
<tr><td>Access token</td><td><input type="text" name="access_token" class="regular-text" value="<?php echo $gocardless_config['access_token']; ?>" /></td></tr>
<tr><td>Merchant ID</td><td><input type="text" name="merchant_id" value="<?php echo $gocardless_config['merchant_id']; ?>" /></td></tr>
<tr><td><input type="checkbox" name="sandbox" id="sandbox" <?php if ($gocardless_config['sandbox']) { echo 'checked'; } ?>/> <label for="sandbox">Sandbox account</label></td></tr>
